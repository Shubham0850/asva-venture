        ...
        <Box px={32} py={8}>
          ...
          <Text>
            <iframe
              ...
              src="https://open.spotify.com/embed/album/1s1hg0fDxYubOCjG5dJT4s?utm_source=generator"
              width="100%"
              height="352"
          ...
          <Text>
            ...
            accusamus ex, illum illo adipisci quo officiis suscipit voluptas et
            unde, dolor error temporibus dignissimos soluta sit fugiat quam
            nesciunt rerum dolore eius dolores consectetur!
          </Text>
        </Box>
